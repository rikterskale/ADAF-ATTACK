...
EXPLOIT_PROFILES: dict[str, dict[str, Any]] = {
    "AdminTo": {
        "impact": "Administrative control of a system",
        "tactic": "Privilege Escalation",
        "techniques": ["T1078"],
    },
    "GenericAll": {
        "impact": "Full control of a directory object",
        "tactic": "Privilege Escalation",
        "techniques": ["T1098"],
    },
    "GenericWrite": {
        "impact": "Write control of a directory object",
        "tactic": "Privilege Escalation",
        "techniques": ["T1098"],
    },
    "WriteDacl": {
        "impact": "Directory object permission control",
        "tactic": "Privilege Escalation",
        "techniques": ["T1222.001"],
    },
    "WriteOwner": {
        "impact": "Directory object ownership control",
        "tactic": "Privilege Escalation",
        "techniques": ["T1222.001"],
    },
    "AddMember": {
        "impact": "Privileged group membership control",
        "tactic": "Privilege Escalation",
        "techniques": ["T1098"],
    },
    "ForceChangePassword": {
        "impact": "Account credential reset control",
        "tactic": "Credential Access",
        "techniques": ["T1098"],
    },
    "AllExtendedRights": {
        "impact": "Extended-rights control of a directory object",
        "tactic": "Privilege Escalation",
        "techniques": ["T1098"],
    },
    "DCSync": {
        "impact": "Directory replication credential exposure",
        "tactic": "Credential Access",
        "techniques": ["T1003.006"],
    },
    "GetChanges": {
        "impact": "Directory replication access component",
        "tactic": "Credential Access",
        "techniques": ["T1003.006"],
    },
    "GetChangesAll": {
    ...
    "CanASREP": {
        "impact": "AS-REP credential material exposure",
        "tactic": "Credential Access",
        "techniques": ["T1558.004"],
    },
    "HasSPN": {
        "impact": "Service-ticket credential material exposure",
        "tactic": "Credential Access",
        "techniques": ["T1558.003"],
    },
    "ReadGMSAPassword": {
        "impact": "Managed service-account credential exposure",
        "tactic": "Credential Access",
        "techniques": ["T1003"],
    },
    ...
    "ReadLAPSPassword": {
        "impact": "Local administrator credential exposure",
        "tactic": "Credential Access",
        "techniques": ["T1003"],
    },
    "LAPSReadable": {
    ...
    "ESC1": {
        "impact": "Certificate-based identity escalation candidate",
        "tactic": "Privilege Escalation",
        "techniques": ["T1649"],
    },
    "ESC1Enrollable": {
        "impact": "Enrollable certificate-based identity escalation",
        "tactic": "Privilege Escalation",
        "techniques": ["T1649"],
        "confidence": "high",
    },
    "ESC2": {
        "impact": "Certificate template identity escalation candidate",
        "tactic": "Privilege Escalation",
        "techniques": ["T1649"],
    },
    "ESC3Agent": {
        "impact": "Certificate request-agent escalation candidate",
        "tactic": "Privilege Escalation",
        "techniques": ["T1649"],
    },
    "ESC4": {
        "impact": "Certificate template control",
        "tactic": "Privilege Escalation",
        "techniques": ["T1649"],
    },
    "ESC6": {
        "impact": "Certificate authority subject-alternative-name abuse condition",
        "tactic": "Privilege Escalation",
        "techniques": ["T1649"],
        "confidence": "high",
    },
    "ESC7": {
        "impact": "Certificate authority management control",
        "tactic": "Privilege Escalation",
        "techniques": ["T1649"],
    },
    "ESC8WebEnrollment": {
        "impact": "Web enrollment relay exposure",
        "tactic": "Credential Access",
        "techniques": ["T1557"],
    },
    "WriteKeyCredentialLink": {
        "impact": "Alternate authentication material control",
        "tactic": "Persistence",
        "techniques": ["T1098"],
    },
    "HasKeyCredentialLink": {
        "impact": "Existing alternate authentication material",
        "tactic": "Persistence",
        "techniques": ["T1098"],
    },
    "AllowedToAct": {
        "impact": "Resource-based constrained delegation exposure",
        "tactic": "Lateral Movement",
        "techniques": ["T1550.003"],
    },
    "WriteRBCD": {
        "impact": "Delegation configuration control",
        "tactic": "Lateral Movement",
        "techniques": ["T1550.003"],
    },
    "UnconstrainedDelegation": {
        "impact": "Unconstrained delegation exposure",
        "tactic": "Credential Access",
        "techniques": ["T1550.003"],
    },
    "AllowedToDelegate": {
        "impact": "Constrained delegation exposure",
        "tactic": "Lateral Movement",
        "techniques": ["T1550.003"],
    },
    "WriteGPO": {
        "impact": "Group Policy deployment control",
        "tactic": "Privilege Escalation",
        "techniques": ["T1484.001"],
    },
    "WriteSYSVOL": {
        "impact": "Group Policy content control",
        "tactic": "Privilege Escalation",
        "techniques": ["T1484.001"],
    },
    "SpoolerOpen": {
        "impact": "Printer service coercion exposure",
        "tactic": "Credential Access",
        "techniques": ["T1187"],
    },
    "EfsrpcOpen": {
        "impact": "EFS RPC coercion exposure",
        "tactic": "Credential Access",
        "techniques": ["T1187"],
    },
}
