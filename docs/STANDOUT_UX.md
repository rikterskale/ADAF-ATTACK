...
The live safety-governor concept was intentionally not added in this iteration, per request. Existing authorization, force, engagement, and rollback safeguards remain unchanged.
